...
async function main() {
  ...
  // so posts oficiais do desenvolvedor (Arrowhead Game Studios) na propria pagina Steam
  // da comunidade, sem misturar materia de imprensa/fansite
  ...
  for (const item of itemsToPost) {
    ...
    const content = `📰 **HELLDIVERS 2 — ${translatedTitle}**\n${translatedSummary}${
